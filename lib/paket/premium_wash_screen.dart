...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(),
      home: PremiumWashScreen(), // Menentukan layar utama aplikasi
    );
  }
}

class PremiumWashScreen extends StatefulWidget {
  const PremiumWashScreen({super.key});

  @override
  _PremiumWashScreenState createState() => _PremiumWashScreenState();
}

class _PremiumWashScreenState extends State<PremiumWashScreen> {
