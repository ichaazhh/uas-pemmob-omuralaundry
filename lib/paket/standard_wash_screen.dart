...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(),
      home: StandardWashScreen(), // Menentukan layar utama aplikasi
    );
  }
}

class StandardWashScreen extends StatefulWidget {
  const StandardWashScreen({super.key});

  @override
  _StandardWashScreenState createState() => _StandardWashScreenState();
}

class _StandardWashScreenState extends State<StandardWashScreen> {
